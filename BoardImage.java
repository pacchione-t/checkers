...
public class BoardImage {
	...
	private WorldImage drawSquare(int state, boolean selected) {
		...
		if (!selected) {
			switch (state) {
				case Checkerboard.WHITE_PIECE: return whitePiece;
				case Checkerboard.BLACK_PIECE: return blackPiece;
				case Checkerboard.WHITE_KING: return whiteKing;
				case Checkerboard.BLACK_KING: return blackKing;
				default: return new EmptyImage();
			}
		}
		else {
			switch (state) {
				case Checkerboard.WHITE_PIECE: return new OverlayImage(selectedSquare, whitePiece);
				case Checkerboard.BLACK_PIECE: return new OverlayImage(selectedSquare, blackPiece);
				case Checkerboard.WHITE_KING: return new OverlayImage(selectedSquare, whiteKing);
				case Checkerboard.BLACK_KING: return new OverlayImage(selectedSquare, blackKing);
				default: return selectedSquare;
			}
		}
	}
